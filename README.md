...
- `skills/chisel-wiki/SKILL.md` — 独立 wiki 管理 `/chisel-wiki`
- `agents/agent-chisel-explorer.md` — as-is 探索 agent
- `agents/agent-chisel-planner.md` — to-be 规划 agent（strategy/decompose 双模式）
...
- `scripts/workflow-status.mjs` — task 状态查询与回退命令
- `scripts/wiki-manage.mjs` — wiki 初始化、合入、查询、health-check
- `scripts/scope-check.mjs` — 变更范围校验
- `scripts/audit-log.mjs` — 全链路审计日志

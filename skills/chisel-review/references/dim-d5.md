...
|----|------------------|---------|---------|--------|--------|
| CR-001 [D5] | task-001 | <描述> | <建议> | high/medium/low | 80-100 |
...
- 项目已有风格本身不完美，但新代码遵循了它（风格参照是项目现状，不是理想状态）
- 不同子目录/模块间风格差异（只要同模块内一致）
- Linter/formatter 能自动修复的格式问题
